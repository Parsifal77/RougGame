...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    [SerializeField] private int dungeonWidth = 80, dungeonHeight = 80;
    [SerializeField][Range(0, 30)] private int offset = 4;
    ...
    private void CreateRooms()
    {
        ...
        (
            spaceToSplit: new BoundsInt(position: (Vector3Int)startPosition,
                size: new Vector3Int(dungeonWidth, dungeonHeight)),
            minWidth: minRoomWidth,
        ...
        {
            var roomCenter = (Vector2Int)Vector3Int.RoundToInt(room.center); // Vector3 -> Vector3Int -> Vector2Int
